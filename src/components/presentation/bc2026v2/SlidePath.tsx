        ...
        <SlideContainerV2 isActive={isActive} mode={mode} slideNumber={slideNumber}>
            <div className="flex flex-col items-center text-center space-y-8 max-w-4xl mx-auto">
                <h2 className="text-3xl sm:text-5xl md:text-7xl font-black text-foreground">
                    Como chegar a <span className="text-gradient">mil mães</span>?
                </h2>
                ...
                <div className={cn(
                    ...
                    <div className="flex items-center gap-3 bg-gradient-to-r from-primary/10 to-secondary/10 border border-primary/20 rounded-2xl p-6 max-w-2xl mx-auto">
