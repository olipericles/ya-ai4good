            ...
            <div className="flex flex-col items-center justify-center text-center space-y-10 max-w-4xl mx-auto">
                ...
                <div className="space-y-8 w-full">
                    ...
                    <div className={cn(
                        ...
                        <div className="bg-card border border-border/50 rounded-2xl p-6 sm:p-8 backdrop-blur-sm flex items-center justify-center hover:border-primary/50 transition-all duration-300">
                            <p className="text-6xl sm:text-7xl md:text-8xl font-black text-gradient">
                                11 MILHÕES
                            </p>
                        </div>
                    </div>
                    ...
                    <div className={cn(
                        ...
                        <div className="bg-card border border-border/50 rounded-2xl p-6 backdrop-blur-sm flex items-center justify-center hover:border-primary/50 transition-all duration-300">
                    ...
                    <div className={cn(
                        ...
                        <div className="bg-gradient-to-r from-primary/10 to-secondary/10 border border-primary/30 rounded-2xl p-6 backdrop-blur-sm flex flex-col items-center justify-center">
                            <p className="text-4xl sm:text-5xl border-b-2 border-primary/30 pb-2 text-gradient font-extrabold">
                                90%
                            </p>
                            <p className="text-xl sm:text-2xl text-secondary font-medium uppercase tracking-wider mt-2">
                                Mulheres Negras
                            </p>
                        </div>
                    </div>
