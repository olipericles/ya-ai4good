    ...
    return (
        <SlideContainerV2 isActive={isActive} mode={mode} slideNumber={slideNumber}>
            <div className="flex flex-col items-center justify-center text-center space-y-8 max-w-4xl mx-auto">
                <h2 className={cn(
                    "text-3xl sm:text-5xl md:text-7xl font-black transition-opacity duration-1000",
                ...
                <div className={cn(
                    ...
                    {items.map((item, i) => (
                        <div
                            key={i}
                            className={cn(
                                "flex flex-col items-center gap-3 p-6 bg-card border border-border/50 rounded-2xl backdrop-blur-sm hover:border-primary/50 transition-all duration-700 ease-out",
                                item.delay,
                ...
                <div className={cn(
                    ...
                    <div className="bg-gradient-to-r from-primary/10 to-secondary/10 border border-primary/30 rounded-2xl p-6 sm:p-8">
