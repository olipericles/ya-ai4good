        ...
        <SlideContainerV2 isActive={isActive} mode={mode} slideNumber={slideNumber}>
            <div className="flex flex-col items-center justify-center h-full gap-8 sm:gap-12 md:gap-16">
                ...
                <div className={`relative inline-block ${isActive ? 'animate-scale-in delay-200' : 'opacity-0'}`}>
                    <img src={yaLogo} alt="Yá Logo" className="h-20 sm:h-28 md:h-36 object-contain mx-auto" />
                ...
                <div className={`${isActive ? 'animate-scale-in delay-300' : 'opacity-0'}`}>
                    ...
                    <p className="text-lg sm:text-xl font-semibold text-foreground mt-4 text-center">
                ...
                <div className={`${isActive ? 'animate-fade-up delay-700' : 'opacity-0'}`}>
                    <div className="inline-block bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl p-4 sm:p-6 border border-primary/20 text-center">
