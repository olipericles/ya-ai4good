    ...
    return (
        <SlideContainerV2 isActive={isActive} mode={mode} slideNumber={slideNumber}>
            <div className="absolute inset-0 w-full h-full flex flex-col items-center justify-center text-center px-4">
                ...
                <div className="absolute bottom-[15%] right-[15%] w-2.5 h-2.5 rounded-full bg-[#8B5A2B] blur-[1px] opacity-70" />
                <div className="absolute top-[70%] left-[5%] w-2 h-2 rounded-full bg-[#E55B3C] blur-[2px] opacity-50" />
                <div className="absolute top-[40%] right-[10%] w-1 h-1 rounded-full bg-[#D4AF37] blur-[1px] opacity-70" />

                {/* Brilho Suave de Fundo Centralizado */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80%] h-[80%] min-w-[600px] min-h-[400px] max-w-[1200px] bg-[#E55B3C]/5 blur-[120px] rounded-full pointer-events-none -z-10" />
