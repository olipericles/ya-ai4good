                ...
                <div className="max-w-6xl mx-auto px-6 relative z-10">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-16">
                        <div className="flex-shrink-0 relative group perspective-1000">
                            ...
                            <div className="relative rounded-[2.5rem] shadow-[0_0_40px_rgba(0,0,0,0.5)] border-[6px] border-[#2A2A2A] bg-black max-w-[321px] w-[321px] h-[570px] overflow-hidden transform rotate-y-[-5deg] group-hover:rotate-y-0 transition-transform duration-700">
                                <video
                                    src={demoVideo}
                                    autoPlay
                                    loop
