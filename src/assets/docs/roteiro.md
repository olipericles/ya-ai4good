# Script V5 — Yá | Brazil Conference 2026

**Versão para 3 apresentadores (Adriele, Luã, Péricles)**
**Tempo total: ~8 minutos**
Alinhado ao mapa de cliques da apresentação web (rota /v2BC2026t).

> **Changelog V4 → V5:**
> - Posições de CLIQUE alinhadas ao mapa real de sub-steps da apresentação
> - Slide 0: incluída fala de abertura da Adriele antes do primeiro CLIQUE
> - Slide 3: fala reescrita (OCR, tolerância a erro, personalidade cultural) + 3 sub-steps visuais
> - Slide 4: ⚠️ DIVERGÊNCIA DE NÚMEROS — mapa usa 14→10→5→3, script original usava 18→10→5→2. Alinhar com o time qual versão é a correta.
> - Slide 5: depoimentos condensados em 1 CLIQUE (não 3 separados)
> - Slide 7: fala reescrita com provocação sistêmica + 4º sub-step visual da provocação
> - Slide 8: "Yá significa mãe" migrou para o Slide 0; Slide 8 agora foca no jogral + credenciais
...
*[Fica ativo para o público escanear e para os mentores fazerem o Q&A.]*

---

## CONTAGEM TOTAL DE CLIQUES

| Slide | Sub-steps | Cliques dentro | +1 pra avançar | Total |
|-------|-----------|----------------|----------------|-------|
| 0 — Espera | 0 | 0 | 1 | **1** |
| 1 — Impacto | 3 | 3 | 1 | **4** |
| 2 — Problema | 4 | 4 | 1 | **5** |
...
## MAPA DE TRANSIÇÕES (5 transições implícitas)

| # | De → Para | Gancho | Onde |
|---|-----------|--------|------|
| 1 | Adriele → Luã | "É falta de ferramenta." → "A Yá é..." | Slide 2 → 3 |
| 2 | Luã → Adriele | "Veio com dados." → Adriele assume piloto | Slide 3 → 4 |
| 3 | Adriele continua | Dados → depoimentos → celebração | Slides 4 → 5 → 6 |
| 4 | Adriele → Péricles | Celebra → projeta "mil mães" | Meio do Slide 6 |
...
| Slide | Tempo | Quem | Energia | Cliques |
|-------|-------|------|---------|---------|
| 0 — Espera | ~10s | Adriele | Antecipação | 1 |
| 1 — Impacto | ~45s | Adriele | Íntima, pausada | 4 |
